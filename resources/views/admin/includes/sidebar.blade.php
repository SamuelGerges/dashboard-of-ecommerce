        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  open ">
                ...
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{route('admin.show_lang')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{route('admin.add_lang')}}" data-i18n="nav.dash.crypto">أضافة لغة جديده</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    <li class="active">
                        <a class="menu-item" href="{{ route('admin.show_all_category') }}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li>
                        <a class="menu-item" href="{{ route('admin.add_category') }}" data-i18n="nav.dash.crypto">أضافة قسم جديد </a>
                    </li>
                </ul>
            </li>
           ...
           {{-- <li class="nav-item"><a href=""><i class="la la-group"></i>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.show_all_vendors')}}"
                                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.add_vendor')}}" data-i18n="nav.dash.crypto">أضافة
                            متجر  </a>
                    </li>
                </ul>
            </li>

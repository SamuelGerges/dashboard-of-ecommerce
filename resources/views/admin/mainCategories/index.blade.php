                        ...
                        <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{route('admin.add_category')}}">إضافة قسم جديد</a>
                                </li>
                                            ...
                                            @isset($categories)
                                                @foreach($categories as $category)
                                                    <tr>
                                                        ...
                                                        <td> <img style="width: 150px; height: 100px;" src="{{$category->image}}" alt="not_existed"></td>
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.change_active',$category -> id)}}"
